...
shishen_map = {
    ...
    ('甲', '戊'): '正官', ('甲', '己'): '七杀', ('甲', '庚'): '正财', ('甲', '辛'): '偏财',
    ('甲', '壬'): '偏印', ('甲', '癸'): '正印',
    
    ('乙', '甲'): '劫财', ('乙', '乙'): '比肩', ('乙', '丙'): '伤官', ('乙', '丁'): '食神',
    ('乙', '戊'): '七杀', ('乙', '己'): '正官', ('乙', '庚'): '偏财', ('乙', '辛'): '正财',
    ('乙', '壬'): '正印', ('乙', '癸'): '偏印',
    
    ('丙', '甲'): '偏财', ('丙', '乙'): '正财', ('丙', '丙'): '比肩', ('丙', '丁'): '劫财',
    ('丙', '戊'): '食神', ('丙', '己'): '伤官', ('丙', '庚'): '正官', ('丙', '辛'): '七杀',
    ('丙', '壬'): '正印', ('丙', '癸'): '偏印',
    
    ('丁', '甲'): '正财', ('丁', '乙'): '偏财', ('丁', '丙'): '劫财', ('丁', '丁'): '比肩',
    ('丁', '戊'): '伤官', ('丁', '己'): '食神', ('丁', '庚'): '七杀', ('丁', '辛'): '正官',
    ('丁', '壬'): '偏印', ('丁', '癸'): '正印',
    ...
    ('庚', '甲'): '正财', ('庚', '乙'): '偏财', ('庚', '丙'): '七杀', ('庚', '丁'): '正官',
    ('庚', '戊'): '食神', ('庚', '己'): '伤官', ('庚', '庚'): '比肩', ('庚', '辛'): '劫财',
    ('庚', '壬'): '偏印', ('庚', '癸'): '正印',
    
    ('辛', '甲'): '偏财', ('辛', '乙'): '正财', ('辛', '丙'): '正官', ('辛', '丁'): '七杀',
    ('辛', '戊'): '伤官', ('辛', '己'): '食神', ('辛', '庚'): '劫财', ('辛', '辛'): '比肩',
    ('辛', '壬'): '正印', ('辛', '癸'): '偏印',
    
    ('壬', '甲'): '偏印', ('壬', '乙'): '正印', ('壬', '丙'): '偏财', ('壬', '丁'): '正财',
    ('壬', '戊'): '七杀', ('壬', '己'): '正官', ('壬', '庚'): '食神', ('壬', '辛'): '伤官',
    ('壬', '壬'): '比肩', ('壬', '癸'): '劫财',
    
    ('癸', '甲'): '正印', ('癸', '乙'): '偏印', ('癸', '丙'): '正财', ('癸', '丁'): '偏财',
    ('癸', '戊'): '正官', ('癸', '己'): '七杀', ('癸', '庚'): '伤官', ('癸', '辛'): '食神',
    ('癸', '壬'): '劫财', ('癸', '癸'): '比肩'
}
